...
public class AppInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
	...
	protected Filter[] getServletFilters() {
		// por causa do csrf a configuração de do encoding (acentos) deve ir para SecurityInitializer. 
		// metodo : beforeSpringSecurityFilterChain(ServletContext servletContext) 
