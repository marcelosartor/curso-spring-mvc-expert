...
public class VendasImpl implements VendasQueries {
	...
	public List<VendaOrigem> totalPorOrigem() {
		List<VendaOrigem> vendasNacionalidade = manager.createNamedQuery("Vendas.totalPorMesOrigem", VendaOrigem.class).getResultList();
	
		vendasNacionalidade.forEach(i->{
			System.out.println(">>>> mes : "+i.getMes()+" nacional : "+i.getTotalNacional()+" internacional : "+i.getTotalInternacional());
		});
